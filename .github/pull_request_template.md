...
- [ ] Describe the problem this PR solves and how.
- [ ] Link related issues or ADR updates.
...
- [ ] Added screenshots/logs/manual QA notes (if UI or behaviour changed).

> Remove checklist items that do not apply, but keep the confirmation boxes visible during review.
