...
3. **Fiber Route Builder:** Follow the conventions documented in `docs/adr_fiber_route_builder.md`.
4. Document any new strings in the product copy sheet (`docs/i18n_copy_catalog.md`, to be created when translations are added).
...
3. Update docs/ADR if new patterns emerge.
