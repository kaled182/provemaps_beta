...
PortPair = Tuple[Any, Any]
DevicePair = Tuple[Any, Any]
SitePair = Tuple[Any, Any]


@pytest.fixture
def authenticated_client(db: Any) -> Client:
...
@pytest.fixture
def sample_sites(db: Any) -> SitePair:
    """Cria sites de teste"""
...
@pytest.fixture
def sample_devices(db: Any, sample_sites: SitePair) -> DevicePair:
...
@pytest.fixture
def sample_ports(db: Any, sample_devices: DevicePair) -> PortPair:
...
class TestFiberCableAPI:
    ...
    def test_create_cable_manual(
        ...
        payload: dict[str, Any] = {
            ...
            'dest_device_id': port2.device_id,
...
class TestFiberCablePermissions:
    ...
    def test_create_cable_unauthenticated(
        self,
        sample_ports: PortPair,
    ) -> None:
