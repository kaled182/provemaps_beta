...
- **Documentation:** See [`../reference/cache_busting.md`](../reference/cache_busting.md) for complete strategy
...
- **Documentation:** See [`../reference/prometheus_static_version.md`](../reference/prometheus_static_version.md) for integration details
